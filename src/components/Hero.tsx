...
export const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-bg-dark">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full flex flex-col items-center justify-center mt-16 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full z-10 py-6">
          ...
          {/* Right Column: Centered Carousel Medallion */}
